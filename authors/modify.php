...
modifyLineCSV(__ROOT__ . '/authors.csv.php', $_POST['index'], $_POST['first_name'] . ";" . $_POST['last_name'] . "\n");
        ...
        <div class="row vh-100 align-items-center justify-content-center">
            <div class="col-md-12">
                <div class="row flex-column p-5 text-center">
                    <h2 class="text-light">Author has been <span class="text-warning">modified</span>!</h2>
